...
final class PP_Admin_Settings {
	...
	static public function get_settings()
	{
		...
		$settings = self::get_option( 'pp_madxartwork_settings', true );
	...
	static public function menu()
	{
		if ( is_main_site() || ! is_multisite() ) {
			...
			if ( current_user_can( 'delete_users' ) ) {
				...
				add_submenu_page( 'madxartwork', $title, $title, $cap, $slug, $func );
			}
		}
	}
    ...
    static private function save_white_label()
    {
        ...
        $settings['support_link']       = isset( $_POST['pp_support_link'] ) ? esc_url_raw( $_POST['pp_support_link'] ) : 'httsp://MadxArtwork.net/contact/';
	...
	static public function save_modules()
	{
		...
		if ( isset( $_POST['pp_enabled_modules'] ) ) {
			update_site_option( 'pp_madxartwork_modules', $_POST['pp_enabled_modules'] );
		}
	}
	...
	static public function reset_settings()
	{
		if ( isset( $_GET['reset_modules'] ) ) {
			delete_site_option( 'pp_madxartwork_modules' );
