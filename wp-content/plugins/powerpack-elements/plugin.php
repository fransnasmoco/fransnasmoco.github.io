...
class Powerpackplugin {
	...
	public function madxartwork_init() {
		$this->_modules_manager = new Modules_Manager();

		// Add element category in panel
		\madxartwork\Plugin::instance()->elements_manager->add_category(
	...
	protected function add_actions() {
		add_action( 'madxartwork/init', [ $this, 'madxartwork_init' ] );
        ...
        add_action( 'madxartwork/preview/enqueue_styles', [ $this, 'enqueue_editor_preview_styles' ] );

		add_action( 'madxartwork/frontend/after_register_scripts', [ $this, 'enqueue_frontend_scripts' ] );
		add_action( 'madxartwork/frontend/after_enqueue_styles', [ $this, 'enqueue_frontend_styles' ] );
	}
