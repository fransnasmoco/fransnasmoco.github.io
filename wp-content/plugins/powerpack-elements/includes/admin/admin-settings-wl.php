    ...
    <table class="form-table">
        <tbody>
            ...
            <tr valign="top">
                ...
                <td>
                    <input id="pp_support_link" name="pp_support_link" type="text" class="regular-text" value="<?php echo $settings['support_link']; ?>" placeholder="https://MadxArtwork.net/contact/" />
                </td>
            </tr>
            <tr valign="top">
                <th scope="row" valign="top">
                    <?php esc_html_e('Hide Support Message', 'powerpack'); ?>
                </th>
                <td>
