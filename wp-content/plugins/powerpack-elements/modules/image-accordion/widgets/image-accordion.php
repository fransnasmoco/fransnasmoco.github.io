                ...
                <?php foreach( $settings['accordion_items'] as $index => $item ) { ?>
                    <?php
                        ...
                        $this->add_render_attribute( $item_key, [
                            'class' => ['pp-image-accordion-item','madxartwork-repeater-item-' . esc_attr( $item['_id'] )]
                        ] );
                        ...
                        if ( $item['show_button'] == 'yes' && !empty( $item['link']['url'] ) ) {
                            ...
                            if ( $settings['button_hover_animation'] ) {
                                $this->add_render_attribute( $button_key, 'class', 'madxartwork-animation-' . $settings['button_hover_animation'] );
                            }
