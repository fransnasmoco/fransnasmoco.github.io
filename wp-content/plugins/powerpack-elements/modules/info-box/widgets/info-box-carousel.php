...
class Info_Box_Carousel extends Powerpack_Widget {
    ...
    protected function render() {
		...
		if ( $settings['button_hover_animation'] ) {
			$this->add_render_attribute( 'info-box-button', 'class', 'madxartwork-animation-' . $settings['button_hover_animation'] );
		}
        
        $this->add_render_attribute( 'icon', 'class', 'pp-info-box-icon' );

		if ( $settings['icon_animation'] ) {
			$this->add_render_attribute( 'icon', 'class', 'madxartwork-animation-' . $settings['icon_animation'] );
		}
        ?>
    ...
    protected function _content_template() {
        ...
        <#
           ...
           if ( settings.button_hover_animation ) {
                view.addRenderAttribute( 'info-box-button', 'class', 'madxartwork-animation-' + settings.button_hover_animation );
           }

           view.addRenderAttribute( 'icon', 'class', 'pp-info-box-icon' );

           if ( settings.icon_animation ) {
                view.addRenderAttribute( 'icon', 'class', 'madxartwork-animation-' + settings.icon_animation );
           }
        #>
        <div {{{ view.getRenderAttributeString( 'info-box-carousel-wrap' ) }}}>
            <div {{{ view.getRenderAttributeString( 'info-box-carousel' ) }}}>
                ...
                <#
                   ...
                   _.each( settings.pp_info_boxes, function( item ) {
