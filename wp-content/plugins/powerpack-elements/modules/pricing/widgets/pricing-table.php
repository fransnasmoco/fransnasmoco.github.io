...
class Pricing_Table extends Powerpack_Widget {
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'table_button_text', 'class', [
				...
				'madxartwork-button',
				'madxartwork-size-' . $settings['table_button_size'],
			]
		);
        
        if ( $settings['button_hover_animation'] ) {
			$this->add_render_attribute( 'table_button_text', 'class', 'madxartwork-animation-' . $settings['button_hover_animation'] );
		}
        ?>
            ...
            <div <?php echo $this->get_render_attribute_string( 'pricing-table' ); ?>>
                ...
                <ul class="pp-pricing-table-features">
                    <?php foreach ( $settings['table_features'] as $index => $item ) : ?>
                        ...
                        ?>
                        <li class="madxartwork-repeater-item-<?php echo $item['_id'] . $pa_class; ?>">
                            <?php
    ...
    protected function _content_template() {
        ?>
        <#
            var buttonClasses = 'pp-pricing-table-button madxartwork-button madxartwork-size-' + settings.table_button_size + ' madxartwork-animation-' + settings.button_hover_animation;
            ...
            <div class="pp-pricing-table">
                <div class="pp-pricing-table-head">
                    ...
                    <div class="pp-pricing-table-title-wrap">
                        <# if ( settings.table_title ) { #>
                            <h3 class="pp-pricing-table-title madxartwork-inline-editing" data-madxartwork-setting-key="table_title" data-madxartwork-inline-editing-toolbar="none">
                                {{{ settings.table_title }}}
                            </h3>
                        <# } #>
                        <# if ( settings.table_subtitle ) { #>
                            <h4 class="pp-pricing-table-subtitle madxartwork-inline-editing" data-madxartwork-setting-key="table_subtitle" data-madxartwork-inline-editing-toolbar="none">
                ...
                <# if ( settings.table_price ) { #>
                    <div class="pp-pricing-table-price-wrap">
                        <div class="pp-pricing-table-price">
                            ...
                            <# } #>
                            <span class="pp-pricing-table-price-value madxartwork-inline-editing" data-madxartwork-setting-key="table_price" data-madxartwork-inline-editing-toolbar="none">
                                {{{ settings.table_price }}}
                            </span>
                            <# if ( settings.table_duration ) { #>
                                <span class="pp-pricing-table-price-duration madxartwork-inline-editing" data-madxartwork-setting-key="table_duration" data-madxartwork-inline-editing-toolbar="none">
                ...
                <ul class="pp-pricing-table-features">
                    ...
                    <# _.each( settings.table_features, function( item ) { #>
                        <li class="madxartwork-repeater-item-{{ item._id }} <# if ( item.exclude == 'yes' ) { #> excluded <# } #>">
                            <# if ( item.feature_icon ) { #>
