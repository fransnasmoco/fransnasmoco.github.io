...
class Buttons extends Powerpack_Widget {
    ...
    protected function render() {
        ...
        if ( $settings['button_animation'] ) {
            $button_animation = 'madxartwork-animation-' . $settings['button_animation'];
        }
        ...
        <div class="pp-buttons-group">
            <?php foreach ( $settings['buttons'] as $index => $item ) : ?>
                ...
                $this->add_render_attribute( $button_key, 'class', [
                        'pp-button',
                        'madxartwork-button',
                        'madxartwork-size-' . $buttonSize,
                        'madxartwork-repeater-item-' . $item['_id'],
                        $button_animation,
                    ]
                );
                ...
                view.addRenderAttribute(
                    button_key,
                    {
                        ...
                        'class': [
                            ...
                            'madxartwork-size-' + buttonSize,
                            'madxartwork-repeater-item-' + item._id,
                            'madxartwork-animation-' + settings.button_animation,
                            item.css_classes,
                        ],
                    }
                );
