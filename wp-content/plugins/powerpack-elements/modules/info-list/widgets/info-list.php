...
class Info_List extends Powerpack_Widget {
		...
		$this->add_control(
			...
			[
				...
				'selectors'             => [
					...
					'(tablet){{WRAPPER}}.pp-info-list-stack-tablet.pp-info-list-icon-top .pp-info-list-connector .pp-infolist-icon-wrapper:before, {{WRAPPER}}.pp-info-list-icon-top .pp-info-list-connector .pp-infolist-icon-wrapper:after' => 'border-right-width: {{SIZE}}px; border-top-width: 0;',
            
					'(mobile){{WRAPPER}}.pp-info-list-stack-mobile.pp-info-list-icon-top .pp-info-list-connector .pp-infolist-icon-wrapper:before, {{WRAPPER}}.pp-info-list-icon-top .pp-info-list-connector .pp-infolist-icon-wrapper:after' => 'border-right-width: {{SIZE}}px; border-top-width: 0;',
				],
                'condition'             => [
                    'connector' => 'yes',
                ],
    ...
    protected function render() {
		...
		if ( $settings['button_animation'] ) {
			$this->add_render_attribute( 'info-list-button', 'class', 'madxartwork-animation-' . $settings['button_animation'] );
		}
                            ...
                            <?php
                                ...
                                if ( $item['pp_icon_type'] != 'none' ) {
                                    ...
                                    if ( $settings['icon_hover_animation'] != '' ) {
                                        $icon_animation = 'madxartwork-animation-' . $settings['icon_hover_animation'];
                                    } else {
                                        $icon_animation = '';
                                    }
                                    ?>
                        ...
                        <div class="pp-info-list-item-inner">
                            <# if ( item.pp_icon_type != 'none' ) { #>
                                <div class="pp-infolist-icon-wrapper">
                                    <# if ( item.pp_icon_type == 'icon' ) { #>
                                        <span class="pp-info-list-icon madxartwork-animation-{{ settings.icon_hover_animation }} {{ item.list_icon }}" aria-hidden="true"></span>
                                    <# } else if ( item.pp_icon_type == 'image' ) { #>
                                        <span class="pp-info-list-image madxartwork-animation-{{ settings.icon_hover_animation }}">
                                            <#
                                            var image = {
                                    ...
                                    <# } else if ( item.pp_icon_type == 'text' ) { #>
                                        <span class="pp-info-list-icon pp-info-list-number madxartwork-animation-{{ settings.icon_hover_animation }}">
                                            {{ item.icon_text }}
                                        </span>
                                    <# } #>
                                </div>
                                ...
                                <# } #>
                                    ...
                                    <# if ( item.link.url != '' && item.link_type == 'button' ) { #>
                                        <div class="pp-info-list-button-wrapper pp-info-list-button-icon-{{ item.button_icon_position }}">
                                            <a href="{{ item.link.url }}">
                                                <div class="pp-info-list-button madxartwork-button madxartwork-size-{{ settings.button_size }} madxartwork-animation-{{ settings.button_animation }}">
                                                    <# if ( item.button_icon != '' ) { #>
