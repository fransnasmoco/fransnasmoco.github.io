                    ...
                    <div class="pp-promo-box-inner-content">
                        <# if ( settings.icon_switch == 'yes' ) { #>
                            <# if ( settings.icon_position == 'above-title' ) { #>
                                <div class="pp-promo-box-icon-wrap">
                                    <span class="pp-promo-box-icon madxartwork-animation-{{ settings.hover_animation_icon }}">
                            ...
                            <# if ( settings.button_text != '' ) { #>
                                <div class="pp-promo-box-footer">
                                    <#
                                        ...
                                        view.addRenderAttribute( 'button_text', 'class', [ 'pp-promo-box-button', 'madxartwork-button', 'madxartwork-size-' + settings.button_size, 'madxartwork-animation-' + settings.button_hover_animation ] );
