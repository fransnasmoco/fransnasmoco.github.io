...
class Offcanvas_Content extends Powerpack_Widget {
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'content', 'class',
            [
				...
				'madxartwork-element-' . $this->get_id(),
            ]
        );
        ...
        if ( $settings['button_animation'] ) {
            $this->add_render_attribute( 'toggle-button', 'class', 'madxartwork-animation-' . $settings['button_animation'] );
        }
			...
			<div <?php echo $this->get_render_attribute_string( 'content' ); ?>>
                ...
                <?php
                    if ( $settings['content_type'] == 'sidebar' ) {
                        ...
                        echo \madxartwork\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_section'] );

                    } elseif ( $settings['content_type'] == 'template' && !empty( $settings['templates'] ) ) {
                        
                        echo \madxartwork\Plugin::$instance->frontend->get_builder_content_for_display( $settings['templates'] );
                        
                    } elseif ( $settings['content_type'] == 'widget' && !empty( $settings['saved_widget'] ) ) {

                        echo \madxartwork\Plugin::$instance->frontend->get_builder_content_for_display( $settings['saved_widget'] );
    ...
    protected function render_saved_template() {
        ...
        if ( $settings['content_type'] == 'section' && !empty( $settings['saved_section'] ) ) {
            ...
            //echo \madxartwork\Plugin::$instance->frontend->get_builder_content_for_display( $pp_template_id );
        } elseif ( $settings['content_type'] == 'template' && !empty( $settings['templates'] ) ) {
