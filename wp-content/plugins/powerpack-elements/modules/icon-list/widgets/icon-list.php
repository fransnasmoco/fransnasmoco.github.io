                        ...
                        <li>
                            ...
                            <# if ( item.pp_icon_type != 'none' ) { #>
                                ...
                                <span class="pp-icon-wrapper {{ icon_class }}">
                                    <# if ( item.pp_icon_type == 'icon' ) { #>
                                        <span class="pp-icon-list-icon madxartwork-animation-{{ settings.icon_hover_animation }} {{ item.list_icon }}" aria-hidden="true"></span>
                                    <# } else if ( item.pp_icon_type == 'image' ) { #>
                                        <span class="pp-icon-list-image madxartwork-animation-{{ settings.icon_hover_animation }}">
                                            <#
                                            var image = {
                                    ...
                                    <# } else if ( item.pp_icon_type == 'number' ) { #>
                                        <span class="pp-icon-list-icon madxartwork-animation-{{ settings.icon_hover_animation }}">
                                            {{ i }}
                                        </span>
                                    <# } #>
                                </span>
