                    ...
                    <div class="divider-text-wrap">
                        ...
                        <span class="pp-divider-content">
                            <# if ( settings.divider_type == 'text' && settings.divider_text != '' ) { #>
                                <{{ settings.text_html_tag }} class="pp-divider-{{ settings.divider_type }} madxartwork-inline-editing" data-madxartwork-setting-key="divider_text" data-madxartwork-inline-editing-toolbar="none">
